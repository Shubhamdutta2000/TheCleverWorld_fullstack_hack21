    ...
    <Grid container justify="space-around">
      <Grid item md={6} className={classes.leftGrid}>
        ...
        <Typography className={classes.leftPara} variant="h5" component="p">
          A mobile covid vaccination strategy using mobile vans powered by real
          time logistics data and modular decision making framework. Ordinary
          people can get easy access to their covid vaccine with just a simple
          register
        </Typography>
